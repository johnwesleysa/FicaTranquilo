...
export default class Maio extends react.Component {
  state = {
    fontsLoaded: false,
  };
    ...
    <View>
      ...
      >
        <View style={style.containerJaneiro}>
          ...
          <Text style={style.textTitleJAN}>Maio</Text>
          <Text style={style.textBodyJan}>
            O Maio Amarelo reacende o debate sobre a prevenção de acidentes de
            trânsito. Já o Maio Vermelho tem por objetivo prevenir a hepatite.
          </Text>
          <Image
            style={{ marginTop: 20, width: 300, height: 300 }}
            source={require("../../pages/img/MAIO_HEPATITE.png")}
          />
        </View>
      ...
      <TouchableOpacity onPress={() => setJaneiro(true)}>
        <ImageBackground
          ...
          source={require("../../pages/img/Maio.png")}
        ></ImageBackground>
      </TouchableOpacity>
    </View>
  );
