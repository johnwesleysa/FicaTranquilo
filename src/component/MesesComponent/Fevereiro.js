    ...
    <View>
      ...
      >
        <View style={style.containerJaneiro}>
          ...
          <Text style={style.textTitleJAN}>Fevereiro</Text>
          <Text style={style.textBodyJan}>
            Fevereiro Roxo é o mês de conscientização sobre as doenças: lúpus,
            fibromialgia e mal de alzheimer. O Fevereiro Laranja, por sua vez,
            conscientiza sobre a leucemia.
          </Text>
          <Image
            style={style.imgFEV}
            source={require("../../pages/img/FEV_ROXO.png")}
          />
        </View>
      ...
      <TouchableOpacity onPress={() => setJaneiro(true)}>
        <ImageBackground
          ...
          source={require("../../pages/img/Fevereiro.png")}
        ></ImageBackground>
      </TouchableOpacity>
    </View>
  );
