    ...
    <View>
      ...
      >
        <View style={style.containerJaneiro}>
          ...
          <Text style={style.textTitleJAN}>Janeiro</Text>
          <Text style={style.textBodyJan}>
            Janeiro Branco é um alerta sobre a saúde mental. A campanha visa
            demonstrar a importância que cuidar da saúde não significa apenas
            cuidar da saúde do corpo. Cuidar da mente também é fundamental para
            o total bem-estar e equilíbrio entre corpo e mente.
          </Text>
          <Image
            style={style.imgJAN}
            source={require("../../pages/img/SAUDE_MENTAL_JAN.png")}
          />
        </View>
      ...
      <TouchableOpacity
        onPress={() => setJaneiro(true)}
        style={{ borderRadius: 15 }}
      >
        <ImageBackground
          style={style.buttonJAN}
          source={require("../../pages/img/janeiro.png")}
        ></ImageBackground>
      </TouchableOpacity>
    </View>
  );
