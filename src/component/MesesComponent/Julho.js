    ...
    <View>
      ...
      >
        <View style={style.containerJaneiro}>
          ...
          <Text style={style.textTitleJAN}>Julho</Text>
          <Text style={style.textBodyJan}>
            O Julho Amarelo traz à tona a conscientização sobre as hepatites
            virais e também sobre o câncer ósseo.
          </Text>
          <Image
            style={{ marginTop: 20, width: 300, height: 300 }}
            source={require("../../pages/img/JUHLO_HEPATITE.png")}
          />
        </View>
      ...
      <TouchableOpacity onPress={() => setJaneiro(true)}>
        <ImageBackground
          ...
          source={require("../../pages/img/Julho.png")}
        ></ImageBackground>
      </TouchableOpacity>
    </View>
  );
